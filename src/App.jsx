        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((service, index) => (
              <div
                key={index}
                className="bg-zinc-900 border border-white/10 rounded-3xl p-8 hover:border-purple-500/40 transition"
              >
        ...
        <div className="max-w-6xl mx-auto">
          <div className="mb-12 text-center">
            ...
            <p className="text-gray-400">
              A selection of original tracks and productions.
            </p>
          </div>
...
<section className="fade-section py-24 px-6 border-t border-white/10 bg-gradient-to-b from-black to-zinc-950">
  <div className="max-w-6xl mx-auto text-center">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      <a href="https://open.spotify.com/artist/07bB80O9umDkGmq0FIfKCm?si=6tfLtNQmTi2EPMLsfHdTjw" target="_blank" rel="noopener noreferrer" className="block">
      ...
      <a href="https://www.youtube.com/@jayashnaithanimusic" target="_blank" rel="noopener noreferrer" className="block">
      ...
      <a href="https://music.apple.com/us/artist/jayash-naithani/1631734935" target="_blank" rel="noopener noreferrer" className="block">
